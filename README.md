# Big-Data-Analytics
This project designs and implements an end-to-end Big Data Analytics Pipeline using a distributed data processing framework, such as Apache Spark, deployed on a compute cluster. The project adheres to Big Data analytics principles by working on "The Horse Racing Results – UK & Ireland (2015–2025)" dataset, which holds 1670880 rows and 37 columns. This project aims answer three main questions: 
